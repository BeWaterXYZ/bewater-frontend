...
export default function CampaignMenu(props: {
  ...
  return (
    ...
    >
      <div
        className="fixed rounded-lg p-[6px] bg-[#0B0C24] border border-[#FFFFFF33] shadow-[0_24px_48px_-12px_#1018282E] font-secondary text-xs text-gray-300 flex flex-col gap-[2px] shadow-lg"
        style={{ top: menuPosition.y - 80 - 120, left: menuPosition.x - 202 }}
      >
        {menuItems.map((item) => {
          return (
