...
const styles = {
  ...
  item: "rounded-[2px] px-2 py-1 flex gap-2 font-bold text-sm leader-5 cursor-pointer hover:bg-[#FFF2] items-center hover:bg-white/20 hover:text-gray-100 transition-colors ease-out duration-300",
...
export default function ProfileMenu(props: {
  ...
  return (
    <div
      id="profile-menu"
      className="font-secondary w-full h-full py-1 px-2 flex text-white items-center relative select-none shadow-lg"
    >
      {showDialog && (
      ...
      {show && (
        <div className="absolute bg-[#25263C] rounded top-10 w-[288px] z-50 shadow-lg">
          {isOrganization && (
          ...
          <div className={styles.section}>
            ...
            {enableOrg && (
              ...
              >
                <div className={styles.itemIcon}>{icons.add_16}</div>
