...
export async function GET(request: NextRequest) {
  ...
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_ENDPOINT}/challenge/${challengeId}`
    );
    if (!response.ok) {
    ...
    return new ImageResponse(
      (
        <div
          style={{
            fontFamily:
              "var(--font-secondary), ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, \
            ...
            alignItems: "center",
            backgroundImage: `url(${
              challenge.yotadata?.mainBanner ??
              challenge.bannerUrl ??
              "https://bewater-static.s3.ap-southeast-1.amazonaws.com/yunying/1.png"
            })`,
            backgroundSize: "1016px 480px",
            backgroundPosition: "center center",
            backgroundRepeat: "no-repeat",
