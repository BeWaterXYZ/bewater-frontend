  ...
  return (
    <div className=" relative overflow-hidden pb-12 md:pb-30 pt-[93px] md:pt-[160px] text-center flex flex-col justify-center bg-[url(/challenge/bg.png)] bg-cover ">
      ...
      {isTeamingEnabled ? (
        ...
        <div className="mt-6 md:mt-12">
          <div className="btn btn-primary-invert body-4 text-day/70 border-day/30 uppercase px-4 py-3 md:px-8 md:py-6 hover:border-day/30 hover:cursor-default bg-transparent">
