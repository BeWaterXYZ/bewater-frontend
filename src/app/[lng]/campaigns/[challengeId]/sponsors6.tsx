const sponsors_tier1 = [
  '/sponsors/PermaDAO-2.png',
  '/sponsors/Arweave.png',
  '/sponsors/tintin_color_horizontal2.svg',
];

const sponsors_tier2 = [
  '/sponsors/Arweave.png',
  '/sponsors/ForwardResearch.png',
  '/sponsors/amazon.png',
  '/sponsors/SevenX.png',
  '/sponsors/DODO.png',
  '/sponsors/Giveaway.png',
  '/sponsors/updaoogo.png',
  '/sponsors/tyyz.png',
  '/sponsors/db3.png',
];
...
export function Sponsors6({ t }: { t: Function }) {
  return (
    <div>
