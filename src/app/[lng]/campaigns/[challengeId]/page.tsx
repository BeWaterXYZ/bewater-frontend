...
import { PrizeSection as PrizeSection153 } from "./prize-section/campaign-153";
  ...
  return (
    <div className="container flex flex-col gap-16 md:gap-30 ">
      <div id="milestone">
        ...
        challenge.id !== "7" &&
        !challenge.yotadata?.disableTimeline ? (
          <Timeline
          ...
          <div className="body-3 md:body-2 [&_p]:px-[4vw] [&_p]:md:px-0 text-white [&_p]:w-dvw md:[&_p]:w-fit [&_a]:border-b [&_a]:border-b-white [&_p]:break-words [&_p]:my-1 md:[&_p]:my-2 [&_h1]:my-4">
            {challenge.description?.endsWith("--edit-by-markdown") ? (
              ...
              (challenge.description ?? "").split("\n").map((s, i) => (
                <p className="py-1 md:py-2" key={i}>
                  {s}
                </p>
              ))
            )}
      ...
      {!challenge.yotadata?.disableAwards && (
        <div className="" id="prizes">
          {challenge.id === "1" ? (
            ...
            <PrizeSection153 t={t} lng={lng} challenge={challenge} />
          ) : (
                            ...
                            >
                              {typeof sp === "string" || !sp.href ? (
                                <Image
                                  ...
                                  width={200}
                                  height={40}
                                  className="w-fit h-8 md:h-10 object-contain"
                                  alt={"Sponsors"}
                                />
                              ) : (
