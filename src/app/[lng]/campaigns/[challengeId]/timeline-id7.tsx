...
export default function Timeline7({
  ...
  return (
    <>
      <div
        className="hidden md:flex body-1 text-center border border-midnight  justify-between items-center p-12 lg:px-32 mt-[100px] "
      ...
      {/* mobile view */}
      <div
        className="flex md:hidden flex-col body-1 text-center border border-midnight  justify-between items-center p-12 lg:px-32 lg:mt-[100px] pr-[280px] mt-16 h-[450px] "
        suppressHydrationWarning
      >
        {data.map((node, index) =>
          node.type === "date" ? (
