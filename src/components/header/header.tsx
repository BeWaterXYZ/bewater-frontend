...
export function Header({ menuData }: Props) {
  return (
    <header className="sticky top-0 bg-bw-back text-bw-fore z-10">
      <div className="header-width h-20 px-5 flex flex-row mx-auto relative">
        <a
          className="h-full flex items-center absolute left-8 top-[50%] -translate-y-[50%]"
          href="/"
        >
