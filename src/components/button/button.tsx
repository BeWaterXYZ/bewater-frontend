...
export const Button = ({ text, type, className }: Props) => {
  return (
    <button
      className={clsx(
        'inline-flex typ-body py-1 px-4 border border-solid rounded-[7px] cursor-pointer w-auto h-8 box-border hover:brightness-90 transition duration-[.15s] ease-out',
        {
