...
export const Callout = () => {
  ...
  useEffect(() => {
    if (elRef.current) {
      elRef.current.style.display = globalThis.localStorage?.getItem(
        "hideCallout"
      )
        ? "none"
        : "flex";
  ...
  return (
    <>
      <div
        ref={elRef}
        className="w-full h-[40px] bg-gradient-to-r from-[#F62584] to-[#480CA7] sticky top-0 z-[12] font-secondary text-gray-50 hidden items-center"
      >
