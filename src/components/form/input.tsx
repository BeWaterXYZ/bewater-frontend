    ...
    <div className={clsx("block group relative mb-5", className)}>
      {label ? (
        <label
          className={clsx("block text-xs text-grey-500 font-bold pb-2", {
            "group-hover:text-day group-focus:text-day group-focus-within:text-day transition-colors":
              !disabled,
          })}
          htmlFor={did}
        >
      ...
      <input
        ...
        className={clsx(
          ...
          {
            error: error,
            "hover:!border-day focus:!border-day focus:outline-none transition-colors":
              !disabled,
          }
        )}
        disabled={!!disabled}
